            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <p>Thank you for your interest in Access To Technology services. Your application has been received and a  staff member will be in touch with you soon to confirm your client qualifies for WorkBC Wage Subsidy and to complete the application process. </p>
                        <p>
