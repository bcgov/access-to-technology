                    ...
                    <div className="col-lg-12">
                        <div>
                            <div className="alert alert-dismissible alert-info">
                                ...
                                <strong>IMPORTANT NOTICE:</strong> <br/>Due to anticipated delays in postal shipping times this upcoming holiday season, it is recommended that Service Providers complete the A2T application process by no later than <strong>November 26, 2021</strong> to ensure clients receive their laptop for training starting in <strong>January 2022</strong>.   
                            </div>
                        </div>
                    </div>
